...
```text
./Aviscribe-0.3.4-x86_64.AppImage --appimage-extract
...
./packaging/windows/package.ps1 -Version 0.5.0

# macOS Apple Silicon; uses codesign, plutil, and hdiutil
bash packaging/macos/package.sh 0.5.0
