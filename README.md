...
```text
./Aviscribe-0.3.0-x86_64.AppImage --appimage-extract
...
./packaging/windows/package.ps1 -Version 0.3.0

# macOS Apple Silicon; uses codesign, plutil, and hdiutil
bash packaging/macos/package.sh 0.3.0

# Ubuntu x64; requires dpkg-deb, curl, and AppImage tooling
bash packaging/linux/package.sh 0.3.0
```
